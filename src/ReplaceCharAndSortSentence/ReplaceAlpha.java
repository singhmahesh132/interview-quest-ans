package src.ReplaceCharAndSortSentence;
...
public class ReplaceAlpha {
	...
	//Manually created a method to remove character from each word, since string.replace() does not appends empty character.
	public static String removeAlphabetFromWord(String word, char alphaToRemove) {
	...
	public static void main(String[] args) {
		...
		String word = "my world is my mom";
		char alpha = 'm';
		...
		//then remove the character from words and sort then as per length
